...
本项目原型基于 [HelloAgents 框架](https://github.com/datawhalechina/hello-agents) 的 Agent 教程 Demo（约 500 行，实现了 Planner-Executor-Reporter 基础流程）。在此基础上进行了大幅架构扩展，核心增量贡献包括：
